    ...
    <div className="container mx-auto py-32 flex justify-center px-6">
      <div className="glass w-full max-w-md p-10 rounded-[2rem] border-border/50">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-black tracking-tighter mb-2">Selamat Datang</h2>
          <p className="text-muted-foreground text-sm font-medium">Masuk ke Symphony Portal</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm font-medium text-muted-foreground">
          Belum punya akun? <Link to="/auth/signup" className="text-primary font-bold hover:underline">Daftar di sini</Link>
        </p>
      </div>
    </div>
  );
